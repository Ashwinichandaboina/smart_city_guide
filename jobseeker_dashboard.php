...
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'jobseeker') {
    header('Location: login.php');  // Redirect to login if not a jobseeker
    exit;
}

// Get the user's email and role from the session
$userEmail = isset($_SESSION['email']) ? $_SESSION['email'] : 'Unknown User';
$userRole = isset($_SESSION['role']) ? $_SESSION['role'] : 'jobseeker';  // Default to 'jobseeker'
...
<head>
    ...
    <style>
        ...
        /* Styling for the jobseeker dashboard */
        .jobseeker-dashboard {
            padding: 20px;
        ...
        .jobseeker-dashboard ul {
            list-style-type: none;
            padding: 0;
        }

        .jobseeker-dashboard ul li {
            margin: 15px 0;
        }

        .jobseeker-dashboard ul li a {
            color: #fff;
        ...
        .jobseeker-dashboard ul li a:hover {
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="jobseeker-dashboard">
            ...
            <ul>
                <li><a href="job_listing1.php">View Job Listings</a></li>
                <li><a href="training_centers1.php">Training and Skill Development</a></li>
                <li><a href="company1.php">Company Profiles</a></li>
